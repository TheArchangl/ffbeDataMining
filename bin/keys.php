...
F_GIFT_MST	GiftMstList	AK5v1YEd	1cJ4IuP9	mst	
...
F_CRAFT_EXT_MST	CraftExtMstList	1GPYxQR3	eHn8EU5o	mst	
...
-	BattleScriptMstList	dhR7sSxt	QuxKHQQT	mst	
F_PURCHASE_AGE_LIMIT_MST	PurchaseLimitMstList	okUH6yV7	ZDvrb16x	mst	
F_RB_SS_MST	RbShortSeasonMstList	-	gY7NiJL8	mst	
F_TOWN_MST	TownMstList	6P9XZ7ts	IavY38oB	mst	
-	TrophyMeterSerifMstList	4Qz7qK51	SGjk89Tr	mst	
...
F_TICKER_MST	TickerMstList	5WJ9MQ3n	-	mst	
F_BANNER_MST	BannerMstList	oB0YVw67	C6ci5pfG	mst	
F_RULE_MST	RuleMstList	-	sf2o1jWL	mst	
F_CLSM_GRADE_MST	ClsmGradeMstList	q14CSpIb	sn8QPJ24	mst	
F_EFFECT_GROUP_MST	EffectGroupMstList	ZM06fUem	-	mst	
...
F_RB_ABILITY_GROUP_MST	RbAbilityGroupMstList	UHk7x2V8	Q83j0GvZ	mst	
...
F_RB_LS_MST	RbLongSeasonMstList	8tR1K79p	2nJN19qh	mst	
...
-	LimitBurstMstList	c5T4PIyL	6q3eIR9k	mst	
...
F_RESOURCE_VERSION_MST_LOCALIZE	ResourceVersionMstLocalizeList	-	JchlFPWK	mst	
...
F_PRODUCT_MST	productMstList	DEC8Jmy2	-	mst	
...
F_EQUIP_ITEM_MST	EquipItemMstList	S67QEJsz	-	mst	
...
F_SHOP_MST	ShopMstList	-	X0FA6Ewh	mst	
F_RECIPE_MST	RecipeMstList	27pGMZDm	JveAwh98	mst	
F_RB_LS_REWARD_MST	RbLongSeasonRewardMstList	0Nc4PkAJ	m7XJdkp1	mst	
...
RmBreakRequest	kWrXKC35	-	/actionSymbol/8BJSL7g0.php	request
...
sgExpdQuestStartRequest	-	60Os29Mg	-	request
sgExpdMileStoneClaimRequest	r4A791RF	t04N07LQ	-	request
UnitClassUpRequest	-	L2sTK0GM	-	request
...
sgExpdEndRequest	2pe3Xa8bpG	cjHumZ2Jkt	-	request
...
PurchaseSettingRequest	-	ePFcMX53	/actionSymbol/9hUtW0F8.php	request
...
FacebookRewardListRequest	8YZsGLED	-	/actionSymbol/8YZsGLED.php	request
sgExpdQuestRefreshRequest	vTgYyHM6lC	vceNlSf3gn	-	request
...
sgExpdAccelerateRequest	-	d3D4l8b4	-	request
...
CampaignAcceptRequest	G6ye0D1t	Xb0G1wcB	-	request
...
FacebookRewardClaimRequest	47R9pLGq	Rja82ZUK	-	request
CraftCancelRequest	79xDN1Mw	68zcUF3E	/actionSymbol/7WdDLIE4.php	request
CraftEndRequest	WIuvh09n	-	/actionSymbol/9G7Vc8Ny.php	request
...
sgExpdRecallRequest	0Fb87D0F	9J02K0lX	-	request
...
sgHomeMarqueeInfoRequest	PBSP9qn5	d3GDS9X8	-	request
RmDungeonStartRequest	R5mWbQ3M	A7V1zkyc	-	request
...
sgExpdQuestInfoRequest	hW0804Q9	-	-	request
...
sgMissionUnlockRequest	LJhqu0x6	ZcBV06K4	-	request
...
F_AI_MST	AIMstList	PCm9K3no	yFr6Kj3P	mst	
F_BATTLE_BG_MST	BattleBgMstList	bqR4p8SN	39mEiDNB	mst	
F_BATTLE_SCRIPT_MST	BattleScriptMstList	i7STtbw8	o28ckLUb	mst	
F_LEARNING_MST	LearningMstList	DLVF0cN1	4HCdYk80	mst	
F_LIMITBURST_LV_MST	LimitBurstLvMstList	0EvyjKh8	g2hZpVW7	mst	
...
EOF
        ...
        foreach ($data as $line) {
            ...
            switch ($type) {
                case 'mst':
                    ...
                    $entry = \Sol\FFBE\GameFile::getEntry($name)
                        ?? \Sol\FFBE\GameFile::getEntry($hash);

                    if ($entry == null) {
                        $entry = new \Sol\FFBE\GameFile($name, $hash, $pass, $class, 'mst');
                        \Sol\FFBE\GameFile::addEntry($entry);
                    } else {
    ...
    \Sol\FFBE\GameFile::save();

    foreach (\Sol\FFBE\GameFile::getEntries() as $entry)
        if (in_array('', [$entry->getKey(), $entry->getName(), $entry->getFile()]) ||
            in_array('-', [$entry->getKey(), $entry->getName(), $entry->getFile()]))
            continue;
        else
